@echo off
start cmd /c "python main.py --logic Random --email=test@email.com --name=bot1 --password=123456 --team etimo"
start cmd /c "python main.py --logic Random --email=test1@email.com --name=bot2 --password=123456 --team etimo"
